...
void ProgramExecutor::UpdateFlags_RCR_16Bit(const Word OldData, int count)
{
	if (count == 1)
	{
...
bool ProgramExecutor::RCR(const Operand& operand)
{
	...
	{
		return Error::LOG("Unhandled Case @RCR");
	}
	++CurrInsIndex;
